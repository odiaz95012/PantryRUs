...
export default function UpdateQuantity(props: Props) {
  ...
  const handleQuantityChange = (newQuantity: number) => {
    ...
    if (props.updateQuantity) {
      props.updateQuantity(newQuantity.toString());
    }
  };
  return <NumberInput aria-label="Quantity Input" min={0} max={MAXINT} defaultValue={props.quantity} value={quantity} onChange={(_, value) => handleQuantityChange(value!)}/>;
}
